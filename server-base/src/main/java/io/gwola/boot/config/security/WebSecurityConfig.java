...
import io.gwola.boot.config.security.jwt.AuthenticationFailHandler;
import io.gwola.boot.config.security.jwt.AuthenticationSuccessHandler;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        registry.and()
                //表单登录方式
                .formLogin()
                .loginPage("/gwola/common/needLogin")
                //登录需要经过的url请求
                .loginProcessingUrl("/gwola/login")
                .permitAll()
                //成功处理类
