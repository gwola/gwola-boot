...
public class GwolaGenerator {
     ...
     * 建议仅需修改
     */
    private static final String description = "角色权限";

    /**
     * 作者名
     * 建议仅需修改
     */
    private static final String author = "Gwola";
     ...
     * 实体类对应包
     */
    private static final String entityPackage = "io.gwola.boot.entity";

    /**
     * dao对应包
     */
    private static final String daoPackage = "io.gwola.boot.dao";

    /**
     * service对应包
     */
    private static final String servicePackage = "io.gwola.boot.service";

    /**
     * serviceImpl对应包
     */
    private static final String serviceImplPackage = "io.gwola.boot.serviceimpl";

    /**
     * controller对应包
     */
    private static final String controllerPackage = "io.gwola.boot.controller";
    ...
    public static void main(String[] args) throws IOException {
        ...
        //模板路径
        String root = System.getProperty("user.dir")+"/server-base/src/main/java/io/gwola/boot/generator/template";
    ...
    private static void generateCode(GroupTemplate gt) throws IOException{
        ...
        //创建文件
        String entityFileUrl = System.getProperty("user.dir")+"/src/main/java/io.gwola.boot/entity/"+className+".java";
        ...
        log.info(daoResult);
        //创建文件
        String daoFileUrl = System.getProperty("user.dir")+"/src/main/java/io.gwola.boot/dao/"+className+"Dao.java";
        ...
        //创建文件
        String serviceFileUrl = System.getProperty("user.dir")+"/src/main/java/io.gwola.boot/service/"+className+"Service.java";
        ...
        //创建文件
        String serviceImplFileUrl = System.getProperty("user.dir")+"/src/main/java/io.gwola.boot/serviceimpl/"+className+"ServiceImpl.java";
        ...
        //创建文件
        String controllerFileUrl = System.getProperty("user.dir")+"/src/main/java/io.gwola.boot/controller/"+className+"Controller.java";
